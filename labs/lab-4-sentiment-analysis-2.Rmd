...
# add id bc after we unnest words this will keep track of where these tweets came from
# dim 2411 x 2
# 10% of all data
...
ggplot(output, 
  ...
  scale_fill_manual("legend", 
                    values = c("Positive" = "green", "Neutral" = "black", "Negative" = "red")) +
...
summary(corpus)
# types refers to specific words
# tokens to total words. tokens is always >= types
```
...
# class of 'tokens' which are lists?
tokens
...
# commented out bc it can get unweidly as you look at fragments of words
...
# the 3 words that appear before the word climate 

head(kwic(tokens, pattern = phrase("climate change"), window = 3))
# the 3 words that appear before and after the word climate 
