---
title: "lab-3-sentiment-analysis"
...
sent_scores
# OFFSET: on average there are three more negative words than positive words per page
```


```{r plot_sent_scores}
# what is the sentiment of page relative to the whole book (which is very negative)?
# see the blue when off-setting
...
## START HERE: after we get data use lnt_read() ##
...
group by day, summarize by mean
plot = x, y = sentiment 
...
4.  Read your Nexis article document into RStudio. (use ..x instead of pdftools)
